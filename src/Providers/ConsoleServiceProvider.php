...
use Bazucompany\Modules\Database\Migrations\Migrator;
...
class ConsoleServiceProvider extends ServiceProvider
{
    ...
    protected function registerDisableCommand()
    {
        $this->app->singleton('command.module.disable', function () {
            return new \Bazucompany\Modules\Console\Commands\ModuleDisableCommand();
        });
    ...
    protected function registerEnableCommand()
    {
        $this->app->singleton('command.module.enable', function () {
            return new \Bazucompany\Modules\Console\Commands\ModuleEnableCommand();
        });
    ...
    protected function registerListCommand()
    {
        $this->app->singleton('command.module.list', function ($app) {
            return new \Bazucompany\Modules\Console\Commands\ModuleListCommand($app['modules']);
        });
    ...
    protected function registerMigrateCommand()
    {
        $this->app->singleton('command.module.migrate', function ($app) {
            return new \Bazucompany\Modules\Console\Commands\ModuleMigrateCommand($app['migrator'], $app['modules']);
        });
    ...
    protected function registerMigrateRefreshCommand()
    {
        $this->app->singleton('command.module.migrate.refresh', function () {
            return new \Bazucompany\Modules\Console\Commands\ModuleMigrateRefreshCommand();
        });
    ...
    protected function registerMigrateResetCommand()
    {
        $this->app->singleton('command.module.migrate.reset', function ($app) {
            return new \Bazucompany\Modules\Console\Commands\ModuleMigrateResetCommand($app['modules'], $app['files'], $app['migrator']);
        });
    ...
    protected function registerMigrateRollbackCommand()
    {
        $this->app->singleton('command.module.migrate.rollback', function ($app) {
            ...
            return new \Bazucompany\Modules\Console\Commands\ModuleMigrateRollbackCommand($migrator, $app['modules']);
        });
    ...
    protected function registerOptimizeCommand()
    {
        $this->app->singleton('command.module.optimize', function () {
            return new \Bazucompany\Modules\Console\Commands\ModuleOptimizeCommand();
        });
    ...
    protected function registerSeedCommand()
    {
        $this->app->singleton('command.module.seed', function ($app) {
            return new \Bazucompany\Modules\Console\Commands\ModuleSeedCommand($app['modules']);
        });
